<h1 class="wp-heading-inline">Report snippet</h1>
<form action="<?php menu_page_url('snippet-menu-function') ?>" method="post">
	...
	<table class="wp-list-table"  style="float: left;width: 70%"> 
		<tbody>
			...
			<tr>
				<td colspan="2">
					<input type="hidden" name="snippet_id" value="<?php echo isset($_GET['report_id']) ? $_GET['report_id'] : '' ?>">
					<input type="submit" name="add_report" value="submit" class="page-title-action">
					<a href="<?php menu_page_url('snippet-menu-function') ?>&new_snippet=1" class="page-title-action">Cancel</a>
				</td>
			</tr>
		</tbody>
	</table>
